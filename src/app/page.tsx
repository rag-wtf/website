...
export default function RAGWTFLanding() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50 dark:from-slate-900 dark:via-blue-900 dark:to-purple-900">
            ...
            <div className="md:hidden mt-4 pb-4 border-t border-white/20">
              <div className="flex flex-col space-y-2 mt-4">
                ...
                <div className="px-4 py-2">
                  <Button variant="secondary" size="sm" className="w-full bg-white/20 text-white border-white/30 hover:bg-white/30">
                    <Github className="w-4 h-4 mr-2" />
                    GitHub
                  </Button>
                </div>
      ...
      {/* Hero Section */}
      <section ref={(el) => sectionRefs.current.overview = el} className="py-20 px-4 relative overflow-hidden bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600">
        {/* Animated Background */}
        ...
        <div className="container mx-auto text-center relative z-10">
          <div className="mb-8">
            ...
            <div className="mb-8">
              ...
              <div className="bg-white/10 backdrop-blur-sm p-6 rounded-lg max-w-2xl mx-auto border border-white/20">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto mb-12">
            <div className="text-center bg-white/10 backdrop-blur-sm rounded-lg p-4 border border-white/20 hover:bg-white/20 transition-all duration-300">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            <Card className="text-center hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              <CardContent className="pt-6">
                ...
                <h3 className="font-semibold mb-2">Enhanced Privacy</h3>
      ...
      {/* Features Section */}
      <section ref={(el) => sectionRefs.current.features = el} className="py-20 px-4 bg-slate-50 dark:bg-slate-900/50">
      ...
      <section ref={(el) => sectionRefs.current.architecture = el} className="py-20 px-4 bg-slate-50 dark:bg-slate-900/50">
        <div className="container mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-slate-900 dark:text-white mb-4">
      ...
      {/* Setup Section */}
      <section ref={(el) => sectionRefs.current.setup = el} className="py-20 px-4 bg-slate-50 dark:bg-slate-900/50">
        <div className="container mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-slate-900 dark:text-white mb-4">
              Installation
      ...
      <section ref={(el) => sectionRefs.current.tech = el} className="py-20 px-4 bg-slate-50 dark:bg-slate-900/50">
        <div className="container mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-slate-900 dark:text-white mb-4">
              Technologies Used
      ...
      {/* Community Section */}
      <section ref={(el) => sectionRefs.current.community = el} className="py-20 px-4 bg-slate-50 dark:bg-slate-900/50">
        <div className="container mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-slate-900 dark:text-white mb-4">
              Community & Roadmap
